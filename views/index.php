...
<div class="loganalyzer">
    ...
    <div class="row-fluid log-actions-bar">
        <a href="<?php echo $this->getUrl(); ?>" id="clear"><span
                    class="label"><?php echo Yii::t('LogAnalyzer.main', 'Clear Log') ?></span></a>

        <span class="sep"></span>

        <?php echo Yii::t('LogAnalyzer.main', 'Log Filter') ?>:
        <a href="#" class="filter-log" rel='all'><span
                    class="label label-inverse"><?php echo Yii::t('LogAnalyzer.main', 'All') ?></span></a>
        ...
        <a href="#" id="stack-showall"><span
                    class="label"><?php echo Yii::t('LogAnalyzer.main', 'Show All') ?></span></a>
        <a href="#" id="stack-collapseall"><span
                    class="label"><?php echo Yii::t('LogAnalyzer.main', 'Collapse All') ?></span></a>
        <hr/>
        <div class="col-4">
            <form action="/admin/log" method="post">
                <input type="text" class="form-control logsearch" placeholder="Search" name="search" value="<?php echo $search; ?>"/>
                <input type="submit" class="btn btn-primary">
            </form>
        </div>
        <hr>
        <?php echo $counter." entries";?>
        <hr/>
    </div>
            ...
            if ($this->filterLog($l)):
                ...
                <div class="line <?= ($flag = !$flag) ? 'odd' : '' ?> <?php echo $status['status'] ?>-line">
                    ...
                    <a href="#" class="stack-btn"><span
                                class="label label-inverse"><?php echo Yii::t('LogAnalyzer.main', 'Show') ?> Stack trace</span></a>
